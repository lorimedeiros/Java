...
public class Reserva {
    ...
    public void atualizaDatas(Date entrada, Date saida){
        ...
        if (entrada.before(agora) || saida.before(agora)){
            throw new IllegalArgumentException("Erro em realizar a reserva. Data de entrada e saída devem ser futuras às anteriores.");
        }
        if (entrada.after(saida)){
            throw new IllegalArgumentException("Erro em realizar a reserva. Data de saída deve ser depois da entrada.");
        }
